...
const PARTNER_PLANS: Plan[] = [
    {
        ...
        features: [
            ...
            'Phí hoa hồng 5% / đơn hàng',
            'Quản lý đặt vé & ghế trống',
    ...
    },
    {
        ...
        description: 'Đặc quyền tối đa - Tối ưu lợi nhuận',
        features: [
            'Miễn phí 100% hoa hồng (0% phí dịch vụ)',
            'Ưu tiên hiển thị Top kết quả tìm kiếm',
            'Badge "Đối tác Premium" nổi bật',
            'Gợi ý tối ưu tuyến xe thông minh bằng AI',
            'Thống kê và báo cáo doanh thu chuyên sâu',
            'Rút tiền không giới hạn, xử lý tự động 24/7',
            'Được tham gia các chương trình Flash Sale',
            'Hỗ trợ ưu tiên qua Hotline riêng 24/7',
        ],
    },
];
